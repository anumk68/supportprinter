...
import cloudIcon from '../assets/images/icons/printers.png';
import printersIcon from '../assets/images/icons/printers.png';
import laptopsIcon from '../assets/images/icons/laptop.png';
import desktopsIcon from '../assets/images/icons/Desktop.png';
import monitorsIcon from '../assets/images/icons/monitor.png';

import polyIcon from '../assets/images/icons/poly.png'
const products = [
    { name: 'Subscriptions, apps, and services', icon: cloudIcon, route: '/subscriptions' },
    { name: 'Printers', icon: printersIcon, route: '/printers' },
