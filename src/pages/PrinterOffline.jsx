...
const PrinterOffline = () => {
  ...
  const tutorials = [
  {
    ...
    image: poster1,
    description: "Learn how you can check the use printer offline setting in Windows 10.",
  },
  {
    title: "How to resolve common print errors using Diagnose & Fix in HP Smart for Windows, macOS",
    image: poster2,
    description:
      ...
      {tutorials.map((item, index) => (
        ...
        >
          ...
          <div className="px-4">
            ...
            <p
              className="text-[16px] leading-[23px] text-[#767676] font-hpsimplifiedregular"
...
<div className="bg-white py-14">
      <div className=" grid grid-cols-1 md:grid-cols-3">
        <div className="flex flex-col items-center h-full">
          ...
          <h3 className="text-[#165DBA] font-semibold text-[24px] mb-2 min-h-[56px]">Contact HP Support</h3>
          ...
          <button className="bg-[#0071bb] text-white px-4 py-2 rounded hover:bg-[#005f99] text-[18px] font-medium cursor-pointer">Contact us</button>
        </div>

        <div className="flex flex-col items-center h-full">
          <div className="flex justify-center mb-4 h-[60px]">
            <img src={Printer_60} alt="Printer Icon" className="w-[48px] h-[48px] object-contain" />
          </div>
          <h3 className="text-[#165DBA] font-semibold text-[24px] mb-2 min-h-[56px]">Identify your printer</h3>
          <p className="text-[16px] text-[#000000] mb-4 px-4 min-h-[72px]">
            Enter your model name or serial number to find drivers and manuals specific to your device.
          </p>
          <div className="flex flex-col items-center gap-4 w-full">
            <input type="text" placeholder="Example: HU65BM18V, LaserJet ..." className="border border-gray-300 rounded text-base px-3 py-2 w-full" />
            <button className="bg-gray-400 text-white px-4 py-2 rounded text-sm font-bold  cursor-pointer tracking-[2px]">Submit</button>
          </div>
        </div>

        <div className="flex flex-col items-center h-full">
          <div className="flex justify-center mb-4 h-[60px]">
            <img src={Folder} alt="Search Icon" className="w-[48px] h-[48px] object-contain" />
          </div>
          <h3 className="text-[#165DBA] font-semibold text-[24px] mb-2 min-h-[56px]">Search our support articles</h3>
          <p className="text-[16px] text-[#000000] mb-4 px-4 min-h-[72px]">
