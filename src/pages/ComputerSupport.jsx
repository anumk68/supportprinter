...
import Touch from "../assets/images/touch.avif"
import Computer from "../assets/images/Computer_1.avif"
import ComputerFeature from "../assets/images/Computer_feature.webp"
import Computerbanner from "../assets/images/Computer_banner_optimized.avif"
import Nopower from "../assets/images/nopower.avif"
const ComputerSupport = () => {
  ...
  return (
    <>
      <div className=" bg-contain bg-no-repeat border-b-1 border-[#cccccc] bg-[right_center] " style={{backgroundImage: `url(${Computerbanner})`}}>
