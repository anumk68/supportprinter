...
const CartridgeIssues = () => {
 


  return (
    <div className=" font-hpsimplifiedlight">
      <div className="container text-lg text-[#0096D6] py-4 ml-6 font-[600]">
...
Cartridge issues
      ...
      <div className="container px-[100px] text-[18px]">
        <p className=" mb-6 ">
          ...
          the printer page is blank or has very little ink. <br/>The fastest way to resolve color or black ink not printing or other
