      ...
      <div className="px-4 sm:px-6 md:px-8 lg:px-12 pt-10 max-w-[1100px] mx-auto">
        ...
        <div className=" px-2">
          <p className="pb-4 text-left">
            ...
            reasons but follow these simple steps and you should be back up and
            running.
          </p>
          ...
          <p className="pt-4 text-left">
            Check that the printer and the device you want to print from are on
            the same network. If you need it, you can{" "}
            <a
              href="#"
