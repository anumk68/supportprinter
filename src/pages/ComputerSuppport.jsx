...
const ComputerSupport = () => {
  return (
    <>
      <div className="bg-[url('/src/assets/images/Computer_banner_optimized.avif')] bg-contain bg-no-repeat border-b-1 border-[#cccccc] bg-[right_center]">
      ...
      <div className="container px-4 py-2 mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-center border-b border-[#cccccc]">
        <div className="flex flex-col items-center space-y-2 px-4 py-4 sm:border-r border-[#cccccc]">
          ...
          <Link to="/redirect" className="text-blue-400 text-lg md:text-lg hover:underline font-[HPSimplifiedLight]">
      ...
      <div className="container mx-auto px-4 py-8 flex flex-col lg:flex-row items-center gap-8 lg:gap-12 border-b border-[#cccccc]">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left space-y-4">
          ...
          <Link to="/redirect" className="block text-blue-500 hover:underline text-sm sm:text-base">
            More support information around Windows 11 <LuChevronRight className="inline-block" />
          </Link>

          <Link to="/redirect" className="block text-blue-500 hover:underline text-sm sm:text-base">
            Need Windows 10 Support? <LuChevronRight className="inline-block" />
          </Link>
        </div>
      </div>
      ...
      <div className="container mx-auto py-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="w-full text-center space-y-4 mx-auto">
          <img className="w-full max-h-28 object-contain" src="/src/assets/images/nopower.avif" alt="" />
          <h3 className="text-2xl">Fix problems booting or <br />turning on your PC</h3>
          ...
          <button className="bg-blue-900 text-white px-5 py-2 rounded-xl">Fix Boot issues</button>
          <h5 className="text-[12px] text-gray-800 font-medium">More support options for this topic</h5>

          <Link to="/redirect" className="text-blue-400 text-base md:text-md hover:underline">
            Operating System Not Found Error<br /> Message Appears On Black Screen <LuChevronRight className="inline-block" />
          </Link><br /><br />
          <Link to="/redirect" className="text-blue-400 text-base md:text-md hover:underline">
            Boot Device Not Found (3F0) or<br /> Automatic Repair Errors <LuChevronRight className="inline-block" />
          </Link>
        </div>

        <div className="w-full text-center space-y-4">
          <img className="w-full max-h-28 object-contain mx-auto" src="/src/assets/images/Computer_1.avif" alt="" />
          ...
          <button className="bg-blue-900 text-white px-5 py-2 rounded-xl">Fix audio issues</button>
          <h5 className="text-[12px] text-gray-800 font-medium">More support options for this topic</h5>

          <Link to="/redirect" className="text-blue-400 text-base md:text-md hover:underline">
            No Audio Device is installed Message<br /> Displays<LuChevronRight className="inline-block" />
          </Link><br /><br />
          <Link to="/redirect" className="text-blue-400 text-base md:text-md hover:underline">
            No Sound from the Speakers <LuChevronRight className="inline-block" />
          </Link>
        </div>

        <div className="w-full text-center space-y-4">
          <img className="w-full max-h-28 object-contain mx-auto" src="/src/assets/images/touch.avif" alt="" />
          <h3 className="text-2xl">Fix display and<br /> touchscreen problems</h3>
          <h5 className="text-md text-gray-700 h-30">
            Resolve problems with your display or<br /> touch panel, and learn how to<br /> configure it correctly.
          </h5>
          <button className="bg-blue-900 text-white px-5 py-2 rounded-xl">Fix Display issues</button>
          <h5 className="text-[12px] text-gray-800 font-medium">More support options for this topic</h5>

          <Link to="/redirect" className="text-blue-400 text-base md:text-md hover:underline">
            Troubleshooting HDMI Display <br />and Sound Issues (Windows 10, 8, 7) <LuChevronRight className="inline-block" />
          </Link><br /><br />
          <Link to="/redirect" className="text-blue-400 text-base md:text-md hover:underline">
            Diagnosing a Liquid Crystal Display<br /> (LCD) for Damage <LuChevronRight className="inline-block" />
          </Link>
        </div>
      </div>
      ...
      <div className="bg-gray-50 py-12 px-4 sm:px-6">
        <div className="container mx-auto flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 mb-10">
          <img src="/src/assets/images/identify_product_all.svg" alt="Magnifier Icon" className="w-16 h-16 sm:w-20 sm:h-20 object-cover" />
          <h2 className="text-xl sm:text-2xl font-light text-gray-800 leading-tight text-center sm:text-left">
            Identify your printer for manuals and<br className="hidden md:block" />specific product information
          </h2>
        </div>
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          <div className="w-full px-2 sm:px-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4">
              ...
              <Link to="/redirect" className="text-blue-500 text-sm hover:underline mt-2 sm:mt-0">
          ...
          <div className="w-full md:border-l md:pl-10 border-gray-300 px-2 sm:px-6">
            ...
            <ul className="space-y-4 text-blue-600 text-sm sm:text-base">
              <li className="flex items-center gap-3">
                ...
                <Link to="/redirect" className="hover:underline text-base">Laptop</Link>
              </li>
              <li className="flex items-center gap-3">
                <img src="/src/assets/images/Desktop.svg" alt="Desktop" className="w-6 h-6" />
                <Link to="/redirect" className="hover:underline text-base">Desktop</Link>
              </li>
            </ul>
          </div>
        </div>
