    ...
    <>
      ...
      <div className="container mx-auto flex flex-col lg:flex-row py-4 items-center gap-10 border-b border-[#cccccc]">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left space-y-4">
          ...
          >
            View unboxing and printer setup videos <ChevronRight className="inline-block" />
          </Link>
          <br />
          <Link
            to="/redirect"
            className="text-blue-400 text-base md:text-lg hover:underline"
          >
            Wireless Print Support <ChevronRight className="inline-block" />
          </Link>
        </div>
      </div>
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="w-full text-center space-y-4 mx-auto">
          <img
            ...
            src="/src/assets/images/Windows 11 logo.avif"
            alt=""
          />
          ...
          <Link
            ...
            className="text-blue-400 text-base md:text-lg hover:underline "
          >
            Fix issues with MSFT updates <ChevronRight className="inline-block" />
          </Link>
          <br />
          <Link
            to="/redirect"
            className="text-blue-400 text-base md:text-lg hover:underline"
          >
            Windows 11 support page <ChevronRight className="inline-block" />
          </Link>
        </div>
        ...
        <div className="w-full text-center space-y-4">
          <img
            ...
            src="/src/assets/images/Printer_2.avif"
            alt=""
          />
          ...
          <Link
            ...
            className="text-blue-400 text-base md:text-lg hover:underline"
          >
            View how to print video <ChevronRight className="inline-block" />
          </Link>
        </div>
        ...
        <div className="w-full text-center space-y-4">
          <img
            className="w-full max-h-48 object-contain mx-auto"
            src="/src/assets/images/printeroffline.avif"
            alt=""
          />
          <h3 className="text-xl h-20">
          ...
          >
            ...
            (Windows, macOS) <ChevronRight className="inline-block" />
          </Link>
        </div>
      </div>
              ...
              <ul className="space-y-2 sm:space-y-3 text-blue-600 text-sm">
                <li>
                  <Link to="/redirect" className="hover:underline block">
                    Locate your product's information label <ChevronRight className="inline-block" />
                  </Link>
                </li>
                <li>
                  <Link to="/redirect" className="hover:underline block">
                    Watch a video <ChevronRight className="inline-block" />
                  </Link>
                </li>
                <li>
                  <Link to="/redirect" className="hover:underline block">
                    Samsung printer help <ChevronRight className="inline-block" />
                  </Link>
                </li>
              </ul>
            </div>
